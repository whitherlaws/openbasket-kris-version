export class GameStart extends Phaser.Scene {
    ...
    create() {
      console.log("Entered GameStart scene");
      ...
      // Game Over text
      this.add.text(this.game.config.width / 2, this.game.config.height / 2 - 300, "Open Basket Game", {
        fontSize: "64px",
        fill: "#fff",
        fontFamily: "Jua",
      }).setOrigin(0.5);
      ...
      // Score display
      this.add.text(this.game.config.width / 2, this.game.config.height / 2 - 200, `Leader Board`, {
        fontSize: "32px",
        fill: "#fff",
        fontFamily: "Jua",
      }).setOrigin(0.5);
      ...
      // Text on top
      const playAgainText = this.add.text(this.game.config.width / 2, this.game.config.height / 2 - 130, "Play", {
        fontSize: "32px",
        fill: "#fff",
        fontFamily: "Jua",
      }).setOrigin(0.5);
